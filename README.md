...
Kernel versions between the floor and ceiling are affected. However, the privilege escalation **only works when user namespaces are enabled**, which is restricted by default in some distros.
